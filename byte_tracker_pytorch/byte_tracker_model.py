...
from byte_tracker_pytorch.utils.kalman_filter import KalmanFilter
from byte_tracker_pytorch.utils import matching
from byte_tracker_pytorch.utils.basetrack import BaseTrack, TrackState
...
class BYTETracker(object):
    ...
    def update(self, output_results, xyxy=True):
        ...
        scores = np.array([o[4] for o in output_results])
        classes = np.array([o[5] for o in output_results])
        bboxes = np.array([o[:4] for o in output_results])
